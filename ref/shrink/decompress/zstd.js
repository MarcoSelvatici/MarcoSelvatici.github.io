...
var real__ZSTD_findDecompressedSize = asm["_ZSTD_findDecompressedSize"]; asm["_ZSTD_findDecompressedSize"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__ZSTD_findDecompressedSize.apply(null, arguments);
};
...
Module["asm"] = asm;
var _ZSTD_decompress = Module["_ZSTD_decompress"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_ZSTD_decompress"].apply(null, arguments) };
var _ZSTD_findDecompressedSize = Module["_ZSTD_findDecompressedSize"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_ZSTD_findDecompressedSize"].apply(null, arguments) };
